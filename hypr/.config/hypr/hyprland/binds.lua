...
hl.bind(main_mod .. " + N", hl.dsp.exec_cmd("kitty -e ~/.cargo/bin/speedtest-tui"))
hl.bind(main_mod .. " + V", hl.dsp.window.float())
hl.bind(main_mod .. " + M", hl.dsp.exec_cmd("hyprshutdown"), { locked = true, long_press = true })
...
hl.bind(main_mod .. " + SHIFT + L", hl.dsp.exec_cmd("hyprlock & sleep 0.1 && hyprctl dispatch 'hl.dsp.dpms({ action = \"disable\" })'"), { release = true })
